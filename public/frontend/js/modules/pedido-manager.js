...
export class PedidoManager {
  ...
  renderizarPedidos() {
    ...
    for (const [pedidoId, pedido] of this.pedidos) {
      ...
      // Asegurar acordeón cerrado por defecto
      const titulo = elementoPedido.querySelector('.acordeon-titulo');
      const contenido = titulo && titulo.nextElementSibling;
  ...
  crearElementoPedido(pedido) {
    ...
    elemento.innerHTML = `
      <div class="w-full flex justify-between items-center px-4 py-3 cursor-pointer acordeon-titulo" style="background:#FBFF14;color:#222;font-weight:bold;" onclick="this.nextElementSibling.classList.toggle('hidden')">
        <span class="font-semibold">
          ${pedido.nombre_cliente} 
          <span class='text-xs' style="color:#444">(${pedido.numero_pedido})</span>
        </span>
      ...
      <div class="px-4 py-3 bg-white acordeon-contenido hidden">
        <!-- Botones de acción -->
